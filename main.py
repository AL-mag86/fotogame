...
find_photo=random.choice(animal_list)
...
lab_anim0=Button(image=img0, highlightthickness=0, command = find_img)
...
lab_anim1=Button(image=img1, highlightthickness=0, command =find_img)
...
lab_anim2=Button(image=img2, highlightthickness=0, command =find_img)
...
lab_anim3=Button(image=img3, highlightthickness=0, command =find_img)
